      ...
      return (
        <div style={{ padding: '.5em' }} className="p-col-12 p-md-3">
          <Panel header={event.title} style={{ textAlign: 'center' }}>
            <img style={{ width: "200px" }} src={`http://localhost:8080/images/${event.image_src}`} alt="asd" />
          ...
          <div className="p-col-12">
            <div className="card card-w-title">
              ...
              <form style={{ margin: "20px 0", display: "flex", }} onSubmit={this.handleCreate}>
                <label for="title"><div style={{ textAlign: "center" }}>Title</div>
                  <InputText
                ...
                <label for="location"><div style={{ textAlign: "center" }}>Location</div>
                  <InputText
                    style={{ width: "100px", marginRight: "10px" }}
                ...
                <label for="seats"><div style={{ textAlign: "center" }}>Seats</div>
                  <InputText
                    style={{ width: "100px", marginRight: "10px" }}
                ...
                <label for="price"><div style={{ textAlign: "center" }}>Price</div>
                  <InputText
                    style={{ width: "100px", marginRight: "10px" }}
                ...
                <label for="description"><div style={{ textAlign: "center" }}>Description</div>
                  <InputText
                    style={{ width: "100px", marginRight: "10px" }}
                ...
                <label for="image"><div style={{ textAlign: "center" }}>Image</div>
                  <InputText
                    type="file"
